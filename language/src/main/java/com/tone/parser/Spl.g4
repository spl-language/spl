/*
 * The parser and lexer need to be generated using "mx create-tone-parser".
 */
...
statement [boolean inLoop] returns [ToneStatementNode result]
:
(
...
return_statement returns [ToneStatementNode result]
:
r='return'                                      { ToneExpressionNode value = null; }
(
...
expression returns [ToneExpressionNode result]
:
...
logic_term returns [ToneExpressionNode result]
:
...
logic_factor returns [ToneExpressionNode result]
:
...
arithmetic returns [ToneExpressionNode result]
:
...
term returns [ToneExpressionNode result]
:
...
factor returns [ToneExpressionNode result]
:
(
    IDENTIFIER                                  { ToneExpressionNode assignmentName = factory.createStringLiteral($IDENTIFIER, false); }
    (
...
member_expression [ToneExpressionNode r, ToneExpressionNode assignmentReceiver, ToneExpressionNode assignmentName] returns [ToneExpressionNode result]
