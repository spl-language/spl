 ...
 * the {@link ToneWhileNode} and {@link ToneWhileRepeatingNode} allows Truffle to perform loop
 * optimizations, for example, compile just the loop body for long running loops.
 */
public final class ToneWhileRepeatingNode extends Node implements RepeatingNode {

    /**
     * The condition of the loop. This in a {@link ToneExpressionNode} because we require a result
    ...
    /** Statement (or {@link ToneBlockNode block}) executed as long as the condition is true. */
    @Child
    ...
    public ToneWhileRepeatingNode(ToneExpressionNode conditionNode, ToneStatementNode bodyNode) {
