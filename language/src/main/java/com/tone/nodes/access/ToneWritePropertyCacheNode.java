...
public abstract class ToneWritePropertyCacheNode extends TonePropertyCacheNode {
     ...
     * guard of {@link ToneWritePropertyCacheNode#writeNewPropertyCached} because there we perform a
    ...
    public static ToneWritePropertyCacheNode create() {
        return ToneWritePropertyCacheNodeGen.create();
    }
