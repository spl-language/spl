...
public abstract class ToneReadPropertyCacheNode extends TonePropertyCacheNode {
    ...
    public static ToneReadPropertyCacheNode create() {
        return ToneReadPropertyCacheNodeGen.create();
    }
