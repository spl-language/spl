 ...
 * expressed in using this base class for {@link ToneLogicalAndNode} and {@link ToneLogicalOrNode}.
 */
public abstract class ToneShortCircuitNode extends ToneExpressionNode {

    @Node.Child
    private ToneExpressionNode left;
    @Node.Child
    private ToneExpressionNode right;
    ...
    public ToneShortCircuitNode(ToneExpressionNode left, ToneExpressionNode right) {
        this.left = left;
        this.right = right;
    }
    ...
    public final boolean executeBoolean(VirtualFrame frame) {
        ...
        try {
            ...
            throw ToneException.typeError(this, e.getResult(), null);
        }
        boolean rightValue;
        try {
            ...
            throw ToneException.typeError(this, leftValue, e.getResult());
        }
