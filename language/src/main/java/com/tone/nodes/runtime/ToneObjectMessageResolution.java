...
import com.tone.nodes.access.ToneReadPropertyCacheNode;
import com.tone.nodes.access.ToneReadPropertyCacheNodeGen;
import com.tone.nodes.access.ToneWritePropertyCacheNode;
import com.tone.nodes.access.ToneWritePropertyCacheNodeGen;
...
public class ToneObjectMessageResolution {
    /*
    ...
    public abstract static class ToneForeignWriteNode extends Node {
        ...
        @Child
        private ToneWritePropertyCacheNode write = ToneWritePropertyCacheNodeGen.create();
        @Child
        ...
        public Object access(DynamicObject receiver, Object name, Object value) {
            ...
            } catch (ToneUndefinedNameException undefinedName) {
    ...
    public abstract static class ToneForeignReadNode extends Node {
        ...
        @Child
        private ToneReadPropertyCacheNode read = ToneReadPropertyCacheNodeGen.create();
        @Child
        private ToneForeignToToneTypeNode nameToToneType = ToneForeignToToneTypeNodeGen.create();
