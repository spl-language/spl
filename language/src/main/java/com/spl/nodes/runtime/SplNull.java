 ...
 * practice.
 */
public final class SplNull implements TruffleObject {

    /**
     * The canonical value to represent {@code null} in Tone.
     */
    public static final SplNull SINGLETON = new SplNull();
     ...
     * them implement {@link TruffleObject} and provide additional {@link SplNullMessageResolution
     * foreign access implementation}.
     */
    @Override
    public ForeignAccess getForeignAccess() {
        return SplNullMessageResolutionForeign.ACCESS;
    }
}
