...
/**
 * Logical operations in Tone use short circuit evaluation: if the evaluation of the left operand
 * already decides the result of the operation, the right operand must not be executed. This is
 * expressed in using this base class for {@link SplLogicalAndNode} and {@link SplLogicalOrNode}.
 */
public abstract class SplShortCircuitNode extends SplExpressionNode {

    @Node.Child
    private SplExpressionNode left;
    @Node.Child
    private SplExpressionNode right;
    ...
    public SplShortCircuitNode(SplExpressionNode left, SplExpressionNode right) {
        this.left = left;
        this.right = right;
    }
    ...
    public final boolean executeBoolean(VirtualFrame frame) {
        ...
        try {
            ...
            throw SplTypeErrorException.typeError(this, e.getResult(), null);
        }
        boolean rightValue;
        try {
            ...
            throw SplTypeErrorException.typeError(this, leftValue, e.getResult());
        }
