...
@GenerateWrapper
public abstract class SplExpressionNode extends SplStatementNode {
    ...
    public boolean executeBoolean(VirtualFrame frame) throws UnexpectedResultException {
        return SplTypesGen.expectBoolean(executeGeneric(frame));
    }

    /**
     * When we use an expression at places where a {@link SplStatementNode statement} is already
    ...
    public InstrumentableNode.WrapperNode createWrapper(ProbeNode probe) {
        return new SplExpressionNodeWrapper(this, probe);
    }
