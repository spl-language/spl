...
public abstract class SplReadPropertyCacheNode extends SplPropertyCacheNode {
    ...
    public static SplReadPropertyCacheNode create() {
        return SplReadPropertyCacheNodeGen.create();
    }
