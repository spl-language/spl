 ...
 * </ul>
 */
public final class SplEvalRootNode extends RootNode {
    ...
    public SplEvalRootNode(SplLanguage language, RootCallTarget rootFunction, Map<String, RootCallTarget> functions) {
